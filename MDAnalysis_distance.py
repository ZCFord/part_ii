...
up = MDAnalysis.Universe(args.u)
up_pro = up.select_atoms('protein')

dn = MDAnalysis.Universe(args.d)
...
plt.scatter((EAup[0] + EBup[0])/2, (FAup[0] + FBup[0])/2, label = '4BW5 (Up)', color = 'black', marker = 'D', s = 40)
plt.scatter((EAdn[0] + EBdn[0])/2, (FAdn[0] + FBdn[0])/2, label = '4XDJ (Down)', color = 'blue', marker = 'D', s = 40)
plt.scatter(Exp_A[0], Fen_A[0], label = 'Chain A start', color = 'red', marker = '^', s = 50, edgecolor = 'black')
plt.scatter(Exp_B[0], Fen_B[0], label = 'Chain B start', color = 'pink', marker = '^', s = 50, edgecolor = 'black')
