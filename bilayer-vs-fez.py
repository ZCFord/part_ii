...
plt.title("Bilayer Thickness vs Time when F < 5.5, E > 11.5, Z > 11.5 ($\AA$)", fontsize = 24)
plt.savefig("bilayervsfez.png", format='png', dpi=300)
plt.savefig("bilayervsfez.svg", format='svg', dpi=300)                               
