...
plt.title("Area per Lipid vs Time when F < 5.5, E > 11.5, Z > 11.5 ($\AA$)", fontsize = 24)
plt.savefig("aplvsfez.png", format='png', dpi=300)
plt.savefig("aplvsfez.svg", format='svg', dpi=300)                               
