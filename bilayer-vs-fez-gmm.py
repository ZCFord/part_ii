...
plt.title("Bilayer Thickness vs Time when F < 6.5, E > 10.5, Z > 10.5 ($\AA$)", fontsize = 24)
plt.savefig("bilayervsfez-gmm.png", format='png', dpi=300)
plt.savefig("bilayervsfez-gmm.svg", format='svg', dpi=300)                               
