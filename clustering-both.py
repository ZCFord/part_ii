...
FE_tot = np.concatenate((F1b1FE, F1b2FE, F30b1FE, F30b2FE, F40b1FE, F40b2FE, F40b3FE, O1b1FE, O1b2FE, O30b1FE, O30b2FE, O40b1FE, O40b2FE, O40b3FE, O50b1FE, O50b2FE, V1b1FE, V1b2FE, V40b1FE, V40b2FE, V40b3FE, V50b1FE, V50b2FE, V60b1FE, V60b2FE, P1b1FE, P1b2FE, P50b1FE, P50b2FE), axis = 0)
...
P1bz = (counting(P1b1z)+counting(P1b2z))/2
P50bz = (counting(P50b1z)+counting(P50b2z))/2
...
P1bhz = (counting_harsh(P1b1z)+counting_harsh(P1b2z))/2
P50bhz = (counting_harsh(P50b1z)+counting_harsh(P50b2z))/2
...
zpercents_harsh = (F1bhz, F30bhz, F40bhz, O1bhz, O30bhz, O40bhz, O50bhz, V1bhz, V40bhz, V50bhz, V60bhz, P1bhz, P50bhz)
zpercents_dff = (F1bdz, F30bdz, F40bdz, O1bdz, O30bdz, O40bdz, O50bdz, V1bdz, V40bdz, V50bdz, V60bdz, P1bdz, P50bdz)
...
P1b1e = probFE[5050:5252,:]
P1b2e = probFE[5252:5454,:]
P50b1e = probFE[5454:5656,:]
P50b2e = probFE[5656:,:]

epercentages_harsh = ((counting_harsh(F1b1e)), (counting_harsh(F1b2e)), (counting_harsh(F30b1e)), (counting_harsh(F30b2e)), (counting_harsh(F40b1e)), (counting_harsh(F40b2e)), (counting_harsh(F40b3e)), (counting_harsh(O1b1e)), (counting_harsh(O1b2e)), (counting_harsh(O30b1e)), (counting_harsh(O30b2e)), (counting_harsh(O40b1e)), (counting_harsh(O40b2e)), (counting_harsh(O40b3e)), (counting_harsh(O50b1e)), (counting_harsh(O50b2e)), (counting_harsh(V1b1e)), (counting_harsh(V1b2e)), (counting_harsh(V40b1e)), (counting_harsh(V40b2e)), (counting_harsh(V40b3e)), (counting_harsh(V50b1e)), (counting_harsh(V50b2e)), (counting_harsh(V60b1e)), (counting_harsh(V60b2e)), (counting_harsh(P1b1e)), (counting_harsh(P1b2e)), (counting_harsh(P50b1e)), (counting_harsh(P50b2e)))

epercentages_diff = ((counting(F1b1e) - counting_harsh(F1b1e)), (counting(F1b2e) - counting_harsh(F1b2e)), (counting(F30b1e) - counting_harsh(F30b1e)), (counting(F30b2e) - counting_harsh(F30b2e)), (counting(F40b1e) - counting_harsh(F40b1e)), (counting(F40b2e) - counting_harsh(F40b2e)), (counting(F40b3e) - counting_harsh(F40b3e)), (counting(O1b1e) - counting_harsh(O1b1e)), (counting(O1b2e) - counting_harsh(O1b2e)), (counting(O30b1e) - counting_harsh(O30b1e)), (counting(O30b2e) - counting_harsh(O30b2e)), (counting(O40b1e) - counting_harsh(O40b1e)), (counting(O40b2e) - counting_harsh(O40b2e)), (counting(O40b3e) - counting_harsh(O40b3e)), (counting(O50b1e) - counting_harsh(O50b1e)), (counting(O50b2e) - counting_harsh(O50b2e)), (counting(V1b1e) - counting_harsh(V1b1e)), (counting(V1b2e) - counting_harsh(V1b2e)), (counting(V40b1e) - counting_harsh(V40b1e)), (counting(V40b2e) - counting_harsh(V40b2e)), (counting(V40b3e) - counting_harsh(V40b3e)), (counting(V50b1e) - counting_harsh(V50b1e)), (counting(V50b2e) - counting_harsh(V50b2e)), (counting(V60b1e) - counting_harsh(V60b1e)), (counting(V60b2e) - counting_harsh(V60b2e)), (counting(P1b1e) - counting_harsh(P1b1e)), (counting(P1b2e) - counting_harsh(P1b2e)), (counting(P50b1e) - counting_harsh(P50b1e)), (counting(P50b2e) - counting_harsh(P50b2e)))
...
P1be = (counting(P1b1e)+counting(P1b2e))/2
P50be = (counting(P50b1e)+counting(P50b2e))/2
...
P1bhe = (counting_harsh(P1b1e)+counting_harsh(P1b2e))/2
P50bhe = (counting_harsh(P50b1e)+counting_harsh(P50b2e))/2
...
epercents_harsh = (F1bhe, F30bhe, F40bhe, O1bhe, O30bhe, O40bhe, O50bhe, V1bhe, V40bhe, V50bhe, V60bhe, P1bhe, P50bhe)
epercents_dff = (F1bde, F30bde, F40bde, O1bde, O30bde, O40bde, O50bde, V1bde, V40bde, V50bde, V60bde, P1bde, P50bde)
...
P1b1 = probabilities[5050:5252,:]
P1b2 = probabilities[5252:5454,:]
P50b1 = probabilities[5454:5656,:]
P50b2 = probabilities[5656:,:]
...
percents_harsh = (F1bh, F30bh, F40bh, O1bh, O30bh, O40bh, O50bh, V1bh, V40bh, V50bh, V60bh, P1bh, P50bh)
...
plt.legend(loc='best')
plt.savefig("clusterbarsall.png", format='png', dpi=300)
plt.savefig("clusterbarsall.svg", format='svg', dpi=300)
...
plt.savefig("clusterbarsavs.png", format='png', dpi=300)
plt.savefig("clusterbarsavs.svg", format='svg', dpi=300)

plt.clf()

width2 = 0.7
plt.figure(figsize = (35,5))
plt.bar(index, percentages_harsh, width2, tick_label = labels, color = 'green')
plt.bar(index, percentages_diff, width2, bottom = percentages_harsh, color = 'green', alpha = 0.5)
plt.ylabel('Percentage of simulation time in Up state')
plt.savefig("clusterbarsall-combined.png", format='png', dpi=300)
plt.savefig("clusterbarsall-combined.svg", format='svg', dpi=300)

plt.clf()

plt.figure(figsize = (15,5))
plt.bar(index2, percents_harsh, width2, tick_label = labelling, color = 'green')
plt.bar(index2, percents_dff, width2, bottom = percents_harsh, color = 'green', alpha = 0.5)
plt.ylabel('Percentage of simulation time in Up state')
plt.savefig("clusterbarsavs-combined.png", format='png', dpi=300)
plt.savefig("clusterbarsavs-combined.svg", format='svg', dpi=300)
